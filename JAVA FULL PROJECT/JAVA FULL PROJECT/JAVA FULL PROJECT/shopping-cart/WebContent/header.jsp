...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		...
		<h6>Top-notch product excellence</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Green SuperMarket</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="index.jsp?type=fuits">Fruits</a></li>
							<li><a href="index.jsp?type=homeware">Homeware</a></li>
							<li><a href="index.jsp?type=groceries">Groceries</a></li>
							<li><a href="index.jsp?type=juice">Juice</a></li>
							<li><a href="index.jsp?type=meet">Meet</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="userHome.jsp?type=hommeware">Homeware</a></li>
							<li><a href="userHome.jsp?type=groceries">Groceries</a></li>
							<li><a href="userHome.jsp?type=juice">Juice</a></li>
							<li><a href="userHome.jsp?type=meet">Meet</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=vegetables">Vegetables</a></li>
							<li><a href="adminViewProduct.jsp?type=fruits">Fruits</a></li>
							<li><a href="adminViewProduct.jsp?type=homeware">Homeware</a></li>
							<li><a href="adminViewProduct.jsp?type=groceries">Groceries</a></li>
							<li><a href="adminViewProduct.jsp?type=juice">Juice</a></li>
							<li><a href="adminViewProduct.jsp?type=meet">Meet</a></li>
						</ul></li>
