					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="vegetables"
								<%="vegitables".equalsIgnoreCase(ptype) ? "selected" : ""%>>Vegetables</option>
							<option value="fruits"
							...
							<option value="homeware"
								<%="homeware".equalsIgnoreCase(ptype) ? "selected" : ""%>>Homeware</option>
							<option value="meet"
								<%="meet".equalsIgnoreCase(ptype) ? "selected" : ""%>>Meet</option>
							<option value="juice"
								<%="juice".equalsIgnoreCase(ptype) ? "selected" : ""%>>Juice</option>
							<option value="other"
								<%="other".equalsIgnoreCase(ptype) ? "selected" : ""%>>Others</option>
						</select>
					</div>
				</div>
				<div class="form-group">
